...
Please note that more advanced topics, such as preprocessing pipeline and how to load in data from 10X, will not be covered in this tutorial. Here are some useful links:

* Processing raw scRNA-seq data: https://scrnaseq-course.cog.sanger.ac.uk/website/processing-raw-scrna-sseq-data.html
* Seurat - Load in data from 10X: https://satijalab.org/seurat/reference/read10x  
